...
// Example projects list (replace with API)
const projects = [
  ...
  return (
    <dialog id="create-bug" className="modal sm:modal-middle">
      <div className="modal-box bg-gray-50 text-gray-900 w-full max-w-lg mx-auto rounded-lg">
        <h2 className="text-2xl font-bold mb-4">Report Bug (Manual Entry)</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          {/* Reported By */}
          <label className="flex flex-col">
            <span className="font-medium">Reported By (User ID) *</span>
            <input
              type="number"
          ...
          {/* Assigned To */}
          <label className="flex flex-col">
            <span className="font-medium">Assigned To (Optional)</span>
