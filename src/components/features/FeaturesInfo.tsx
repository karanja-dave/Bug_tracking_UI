...
import { CheckCircle, Bug, FolderKanban } from "lucide-react";
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-20 space-y-20">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10">
        <h3 className="text-blue-600 font-semibold uppercase tracking-wider text-sm">
          Features
        </h3>
        <h2 className="text-4xl font-bold mt-3">
          Everything you need to manage projects and track work effortlessly
        </h2>
      ...
      {/* Wrapper for all feature blocks */}
